        ...
        <div className="p-6">
            ...
            {isLoading ? (
                ...
                <div className="overflow-x-auto">
                    <table className="table text-2xl table-zebra w-full">
                        <thead>
                                ...
                                <tr key={parcel._id}>
                                    ...
                                    <td>
                                        <button
                                            ...
                                            className="btn btn-xl bg-[#CAEB66] whitespace-nowrap btn-primary text-black">
                                            <FaMotorcycle size={35} className="inline-block mr-1" />
                                            Assign Rider
                                        </button>
                                    </td>
                                </tr>
